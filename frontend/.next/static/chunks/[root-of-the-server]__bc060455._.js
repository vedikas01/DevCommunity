...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$link$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/link.js [client] (ecmascript)"); // <--- ADD THIS LINE
;
...
function Login() {
    ...
    const handleLogin = async ()=>{
        ...
        try {
            ...
            // Store token and user data received from the backend
            localStorage.setItem('token', res.data.token);
            localStorage.setItem('user', JSON.stringify(res.data.user)); // Store the user object
            router.push('/'); // Redirect to the homepage after successful login
        } catch (err) {
            console.error('Login Failed:', err.response?.data || err.message);
            setError(err.response?.data?.error || 'Login failed. Please check your credentials.'); // Display specific error or generic
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bc060455._.js.map