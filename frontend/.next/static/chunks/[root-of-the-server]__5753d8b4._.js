...
"[project]/components/PostCard.js [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function PostCard({ post: initialPost }) {
    _s();
    const { isAuthenticated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const [post, setPost] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(initialPost);
    const [currentUserId, setCurrentUserId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"])();
    ...
    const handleVote = async (voteType)=>{
        ...
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post(endpoint, {}, {
                headers: {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            !post.author && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "font-semibold text-gray-700",
...
_s(PostCard, "24K4U0wI6bK9iAP6xcNzJAOFtJY=", false, function() {
    return [
...
"[project]/pages/user/[id].js [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$PostCard$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/PostCard.js [client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
;
;
...
function UserProfile() {
    ...
    const { user: currentUser, isAuthenticated, token, updateUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const backendBaseUrl = ("TURBOPACK compile-time value", "http://localhost:5000");
    const [profileUser, setProfileUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [loadingPosts, setLoadingPosts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [errorPosts, setErrorPosts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [isFollowing, setIsFollowing] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const fetchProfileAndPosts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UserProfile.useCallback[fetchProfileAndPosts]": async ()=>{
            if (!id) return;
            setLoading(true);
            ...
            setErrorPosts(null);
            try {
                const profileRes = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`/users/${id}`);
                ...
                if (currentUser && profileRes.data.user && profileRes.data.user.followers) {
                    setIsFollowing(profileRes.data.user.followers.some({
                        "UserProfile.useCallback[fetchProfileAndPosts]": (follower)=>follower._id === currentUser._id
                    }["UserProfile.useCallback[fetchProfileAndPosts]"]));
                }
            } catch (err) {
            ...
            try {
                const postsRes = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`/posts?authorId=${id}`);
    ...
    const handleFollowToggle = async ()=>{
        ...
        try {
            let res;
            if (isFollowing) {
                res = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post(`/users/${profileUser._id}/unfollow`, {}, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
                ...
                res = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post(`/users/${profileUser._id}/follow`, {}, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
        ...
        children: [
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            isAuthenticated && currentUser && currentUser._id !== profileUser._id && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    loadingPosts ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        lineNumber: 155,
                        columnNumber: 11
                    }, this) : errorPosts ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        lineNumber: 157,
                        columnNumber: 11
                    }, this) : userPosts.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "space-y-6",
                        children: userPosts.map((post)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$PostCard$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"], {
                                post: post
                            }, post._id, false, {
                                fileName: "[project]/pages/user/[id].js",
                                lineNumber: 160,
...
_s(UserProfile, "TSBbangxeP7RH/nVQ1vG4sWrP6I=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5753d8b4._.js.map