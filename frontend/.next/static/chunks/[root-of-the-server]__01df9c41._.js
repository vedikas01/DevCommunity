...
const AuthProvider = ({ children })=>{
    ...
    const [user, setUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(null); // { _id, username, email, avatarUrl, bio, followers, following }
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(true); // To indicate if initial loading from localStorage is complete
    ...
    }["AuthProvider.useEffect"], []); // Empty dependency array means this runs once on mount
...
"[project]/pages/create.js [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/context/AuthContext.js [client] (ecmascript)"); // <--- IMPORT useAuth hook
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/router.js [client] (ecmascript)");
;
...
function CreatePost() {
    ...
    const [contentMarkdown, setContentMarkdown] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])('');
    const { isAuthenticated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useAuth"])(); // <--- GET isAuthenticated from context
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post('/posts', {
                title,
                contentMarkdown
            }, {
                headers: {
...
_s(CreatePost, "GpBXqRLS9OgYY2ulKvv5HvABblw=", false, function() {
    return [
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/pages/create.js [client] (ecmascript)\" } [client] (ecmascript)": (function(__turbopack_context__) {
...
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/pages/create.js [client] (ecmascript)");
    }
]);
...
"[project]/pages/create (hmr-entry)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, m: module } = __turbopack_context__;
{
__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/pages/create.js [client] (ecmascript)\" } [client] (ecmascript)");
}}),
}]);

//# sourceMappingURL=%5Broot-of-the-server%5D__01df9c41._.js.map