...
//       <div>
//         <Link href="/">
//           <span className="font-bold text-lg">DevCommunity</span>
//         </Link>
//       </div>
...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get('/api/posts').then({
                "Home.useEffect": (res)=>setPosts(res.data)
            }["Home.useEffect"]);
        }
    }["Home.useEffect"], []);
