...
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/context/AuthContext.js [ssr] (ecmascript)"); // Make sure you have this import if you're using AuthContext
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$link$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/link.js [ssr] (ecmascript)"); // Import Link for the login link
...
function Register() {
    ...
    const { login } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["useAuth"])(); // If you have a login function in AuthContext, use it
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            // These lines assume your backend's /auth/register endpoint
            // returns both `token` and a `user` object (e.g., res.data.user = {_id, username, email})
            localStorage.setItem('token', res.data.token);
            localStorage.setItem('user', JSON.stringify(res.data.user)); // Store the user object
            // If you want to auto-login after register, use AuthContext's login:
            if (login) login(res.data.token, res.data.user);
            alert('Registration successful!');
            router.push('/'); // Redirect to homepage after registration
        } catch (err) {
            console.error('Registration Failed:', err.response?.data || err.message);
            alert(err.response?.data?.error || 'Registration failed.'); // Provide user feedback
        }
    };
    return(// Outer div with the specified styling
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("form", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("input", {
                        className: "border p-2 w-full mt-4" // Added mt-4 for spacing after h2
                        ,
                        value: username,
