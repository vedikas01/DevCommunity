...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/api.js [ssr] (ecmascript)"); // Ensure this points to your configured axios instance
...
function Register() {
    ...
    const [bio, setBio] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])(''); // New state for bio
    const [avatar, setAvatar] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])(null); // New state for avatar file
    const [avatarPreview, setAvatarPreview] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])(null); // New state for avatar preview
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])(false); // For showing loading state during registration
    ...
    const handleAvatarChange = (e)=>{
        ...
        if (file) {
            setAvatar(file);
            // Create a URL for image preview (will be revoked on component unmount or next file change)
    ...
    const handleSubmit = async (e)=>{
        ...
        if (avatar) {
            formData.append('avatar', avatar); // 'avatar' must match the field name used in multer.single() on backend
        }
        try {
            // Axios automatically sets Content-Type to 'multipart/form-data' when sending FormData
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/register', formData);
            console.log('Registration Success:', res.data);
            // res.data.user should now contain: _id, username, email, avatarUrl, bio, followers, following
...
([__TURBOPACK__imported__module__$5b$project$5d2f$pages$2f$register$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__570813e4._.js.map