...
//         <h2 className="text-xl font-semibold cursor-pointer hover:underline">{post.title}</h2>
//       </Link>
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$formatDistanceToNow$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/date-fns/formatDistanceToNow.js [ssr] (ecmascript)"); // You'll need to install date-fns: npm install date-fns
var __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/react [external] (react, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/api.js [ssr] (ecmascript)"); // Ensure axios is imported
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
...
function PostCard({ post }) {
    const [voteCount, setVoteCount] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])(post.upvotes - post.downvotes);
    const [userVote, setUserVote] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])(0); // 0: no vote, 1: upvote, -1: downvote
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
    // In a real app, you'd fetch the user's vote for this post
    // For now, let's assume no prior vote.
    // You'll need to update your backend to store and retrieve user's votes.
    }, [
        post._id
    ]);
    const handleVote = async (type)=>{
        ...
        if (type === 'up') {
            if (userVote === 1) newVote = 0; // Un-upvote
            else newVote = 1; // Upvote
        } else {
            if (userVote === -1) newVote = 0; // Un-downvote
            else newVote = -1; // Downvote
        }
        try {
            // Assuming your backend has an endpoint like PATCH /posts/:id/vote
            // And expects { voteType: 'up' | 'down' | 'none' }
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].patch(`/posts/${post._id}/vote`, {
                voteType: newVote === 1 ? 'up' : newVote === -1 ? 'down' : 'none'
            }, {
                headers: {
            ...
            // Optimistic update
            setVoteCount((prev)=>prev - userVote + newVote);
            setUserVote(newVote);
        } catch (error) {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("button", {
                        ...
                        className: `text-gray-500 hover:text-orange-500 ${userVote === 1 ? 'text-orange-500' : ''}`,
                        "aria-label": "Upvote",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__88b94fde._.js.map